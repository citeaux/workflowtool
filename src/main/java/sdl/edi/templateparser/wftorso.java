...
public class wftorso {
    ...
    public List<wfproperties> getProps() {
		return props;
	}

	public void setProps(List<wfproperties> props) {
		this.props = props;
	}
	...
	public long getRuleidbefore() {
		return ruleidbefore;
	}

	public void setRuleidbefore(long ruleidbefore) {
		this.ruleidbefore = ruleidbefore;
	}

	public long getRuleidafter() {
		return ruleidafter;
	}

	public void setRuleidafter(long ruleidafter) {
		this.ruleidafter = ruleidafter;
	}
